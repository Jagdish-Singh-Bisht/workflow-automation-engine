...
public class WorkflowEngine {
    ...
    public String runWorkflow(WorkflowRunRequest request) {
        ...
        context.put("user", workflow.getUser());
        ...
        try {
            ...
            List<WorkflowNode> nodes =
                    workflowNodeRepository
                            .findByWorkflowOrderBySequenceOrderAsc(
                                    workflow
                            );
